...
Namespace MultiUserOutlookSync
	Partial Public Class MainForm
		...
		Private Sub InitializeComponent()
			...
			Me.schedulerControl1.Size = New System.Drawing.Size(949, 384)
			Me.schedulerControl1.Start = New System.DateTime(2007, 11, 19, 0, 0, 0, 0)
...
'			Me.schedulerStorage1.AppointmentsChanged += New DevExpress.XtraScheduler.PersistentObjectsEventHandler(Me.schedulerStorage1_AppointmentsChanged);
			...
			Me.scheduleBindingSource.DataSource = Me.dataSet1
			' 
			' dataSet1
			' 
...
'			Me.btnExport.Click += New System.EventHandler(Me.button2_Click);
			' 
			' btnImport
			' 
...
'			Me.btnImport.Click += New System.EventHandler(Me.button1_Click);
			' 
			...
			Me.progressBarControl1.Location = New System.Drawing.Point(0, 425)
			Me.progressBarControl1.Name = "progressBarControl1"
			Me.progressBarControl1.Size = New System.Drawing.Size(949, 10)
